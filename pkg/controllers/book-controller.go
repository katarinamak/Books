...
import (
	...
	"github.com/katarinamak/Books/pkg/models"
	"github.com/katarinamak/Books/pkg/utils"
)
...
func DeleteBook(w http.ResponseWriter, r *http.Request) {
	vars := mux.Vars(r)                       // access the request that you have received from the user
	bookId := vars["bookId"]                  // access the book id
	ID, err := strconv.ParseInt(bookId, 0, 0) // convert the ID to int
	if err != nil {
		fmt.Println("error while parsing")
	}
